...
sudo sed -i "s/error_reporting = .*/error_reporting = E_ALL & ~E_DEPRECATED & ~E_STRICT/" /etc/php5/cli/php.ini
sudo sed -i "s/display_errors = .*/display_errors = Off/" /etc/php5/cli/php.ini
